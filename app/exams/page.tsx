...
import { useAllServicesQuery } from "@/gen/gql";
import React, { useEffect, useState } from "react";

type Props = {};

const page = (props: Props) => {
  const { data, loading, refetch } = useAllServicesQuery();
      ...
      <div id="mainbar-full">
        <div className="d-flex mb24">
          <div className="flex--item fl1">
            <h1 className="fs-headline mb0">
              Departamento de Exámenes Auxiliares
            </h1>
            <p className="fs-body1 fc-light fl-grow1 mb0">
              Todos los exámenes auxiliares
            </p>
          </div>
        ...
        <ServiceSearch data={data!} loading={loading} />
      </div>
    </Container>
  );
};
